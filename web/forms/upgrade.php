 ...
 ********************************************************************************/
	...
	define('NEW_MACHFORM_VERSION', '16');
				...
				<div style="padding-top: 10px">
					...
					<?php 	}else if($installation_success && ($current_machform_version !== '2')){ ?>
								<div>
									...
									<!-- Force refresh important JS/CSS after upgrade  -->
									<link rel="stylesheet" type="text/css" href="css/main.css?t=<?php echo time(); ?>" media="screen" /> 
									<script type="text/javascript" src="view.js?t=<?php echo time(); ?>"></script>
									<script type="text/javascript" src="js/mf.js?t=<?php echo time(); ?>"></script>
									<script type="text/javascript" src="js/machform_loader.js?t=<?php echo time(); ?>"></script>
									<script type="text/javascript" src="js/builder.js?t=<?php echo time(); ?>"></script>
