					...
					<div id="element_properties_form">
						...
						<li class="clear" id="prop_address_options">
							...
							<span>	
									...
									<span class="icon-question helpicon" data-tippy-content="Hide the 'Address Line 2' field from the address field."></span>
									<br/>
...
<script type="text/javascript" src="js/tippy.index.all.min.js"></script>
