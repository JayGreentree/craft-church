...
<link rel="stylesheet" type="text/css" href="css/bb_buttons.css" media="screen" /> 
...
<?php
	...
	if(!empty($active_admin_theme)){
		if($current_nav_tab == 'edit_theme' && $active_admin_theme == 'dark'){
			...
			echo '<link href="css/themes/theme_dark_edit_theme.css" rel="stylesheet" type="text/css" />';
		}else{
			echo '<link href="css/themes/theme_'.$active_admin_theme.'.css" rel="stylesheet" type="text/css" />';
		}
	}else{
		echo '<link href="css/themes/theme_vibrant.css" rel="stylesheet" type="text/css" />';
	}
?>
