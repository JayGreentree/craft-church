					...
					if($show_approval_controls){
						if($key == 0){ //this is "id" column
							...
							if($current_row_approval_status == 'approved'){
								$table_body_markup .=  '<td class="me_approval"><span class="icon-circle2" style="color: #77B845;margin-right: 5px"></span> Approved</td>'."\n";
							}else if($current_row_approval_status == 'denied'){
								$table_body_markup .=  '<td class="me_approval"><span class="icon-circle2" style="color: #dd3a37;margin-right: 5px"></span> Denied</td>'."\n";
								...
								if(in_array($_SESSION['mf_user_id'], $current_row_approval_queue_user_id_array)){
									...
									$table_body_markup .=  '<td class="me_approval"><span class="icon-circle2" style="color: #C1C1C1;margin-right: 5px"></span> Pending</td>'."\n";
								}
							}
						}else if($key == 3){
