...
EOT;
	...
	function mf_approval_notify_approvers($dbh,$form_id,$entry_id,$approvers){
		...
		$approver_notify_subject = "Approval Required - {form_name} [#{entry_no}]";
		$approver_notify_content = "This entry needs your approval.<br/><br/>Please approve or deny by using the link below:<br/><strong>{$view_entry_link}</strong><br/><br/><hr style=\"width: 60%;margin-top: 20px;margin-bottom: 20px\"><br/>{entry_data}";
