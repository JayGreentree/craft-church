...
$(function(){
	...
	$('#ls_box_email_rules').delegate('select.condition_fieldname', 'change', function(e) {
			...
			$(this).parent().find('.condition_text,.condition_time,.condition_number,.condition_date,.condition_checkbox,.condition_approval_status,.condition_keyword,.condition_select').hide();
			$(this).parent().removeClass('condition_date');
	...
	//delegate change event to the condition type dropdown (for number, date. checkbox)
    $('#ls_box_email_rules').delegate('select.condition_number,select.condition_date,select.condition_checkbox,select.condition_approval_status', 'change', function(e) {
		$(this).parent().data('rule_condition').condition = $(this).val();
    });
	...
	//delegate change event to the condition type dropdown (for number, date. checkbox)
    $('#ls_box_webhook_rules').delegate('select.condition_number,select.condition_date,select.condition_checkbox,select.condition_approval_status', 'change', function(e) {
		$(this).parent().data('rule_condition').condition = $(this).val();
    });
