...
define('MF_DB_NAME', 'jaygreen_forms'); //The name of your database. Note that this database must exist before running installer.php
define('MF_DB_USER', 'jaygreen_forms'); //Your database username
define('MF_DB_PASSWORD', 'rYV0jf{4{rX,{UeO#g'); //Your database users password
