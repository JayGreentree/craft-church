						...
						<table data-incomplete="0" id="entries_table" width="100%" cellspacing="0" cellpadding="0" border="0">
							<thead>
								<tr>
									...
									<th style="width: 160px" scope="col"><div title="Date Created">Time</div></th>
									<th scope="col"><div title="Text 1">Activity</div></th>
									<th style="width: 150px" scope="col"><div title="Text 2">User</div></th>
									<th style="width: 150px" scope="col"><div title="Text 2">Origin</div></th>
								</tr>
							</thead>
							<tbody>
