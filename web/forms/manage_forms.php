 ...
 ********************************************************************************/
	...
	if($_SESSION['form_stats_refreshed'] !== true){
								...
								<div class="middle_form_bar">
									...
									<div class="form_meta">
										...
										<div id="action_toggle_content_<?php echo $form_id; ?>" style="display: none">
											...
											<?php if(!empty($_SESSION['mf_user_privileges']['priv_administer']) || !empty($user_permissions[$form_id]['edit_form'])){ ?>
											<div class="form_action_item"><a title="View Form Info" href="form_info.php?id=<?php echo $form_id; ?>"><span class="icon-file-charts"></span> Info</a></div>
											<?php } ?>
